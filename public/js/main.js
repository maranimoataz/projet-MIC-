...
function getDeletingProduction(id,titre){
    ...
    document.getElementById('delete_production_button').href = '/acces_partenaire/productions/' + id + '/destroy';
}

function getDeletingActualite(id,titre){
    document.getElementById('actualite_title').innerText = titre;
    document.getElementById('delete_actualite_button').href = '/acces_partenaire/actualites/' + id + '/destroy';
}

function getDeletingUser(id,first_name,last_name){
    document.getElementById('user_name').innerText = last_name + ' ' + first_name;
    document.getElementById('delete_user_button').href = '/acces_partenaire/users/' + id + '/destroy';
}
...
function getUpdatingProduction(id,titre,resume,lien){
    ...
    document.getElementById('update_form').action = '/acces_partenaire/productions/' + id + '/update';
}

function getUpdatingActualite(id,titre,date,resume, importance,type){
    document.getElementById('id').value = id;
    document.getElementById('titre').value = titre;
    ...
    if(type == 'evenement')
        ...
        document.getElementById('actualite').checked = true;
    document.getElementById('update_form').action = '/acces_partenaire/actualites/' + id + '/update';
}
...
function getUpdatingUser(id, first_name, last_name, email, institut){
    ...
    document.getElementById('update_form').action = '/acces_partenaire/users/' + id + '/update';
}
